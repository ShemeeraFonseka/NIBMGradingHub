...
{
    public partial class verifyAccEu : MetroFramework.Forms.MetroForm
    {
        String randomCode;
        ...
        private void verifyAccEu_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    try
                    {
                        ...
                        enterVCodeEu en = new enterVCodeEu();
                        en.Show();
                        this.Close();
                    }
