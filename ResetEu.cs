...
{
    public partial class ResetEu : MetroFramework.Forms.MetroForm
    {
        public ResetEu()
        {
            InitializeComponent();
        ...
        private void ResetEu_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    con.Open();
                    cmd = new SqlCommand("Update ExamUnit_Details set Password = '" + txt_pwd.Text + "' where Member_ID = '" + comboBox1.Text + "'", con);
